...
import com.firemax.dailyspin.unlocker.databinding.ActivityQuiz4Binding;
import com.firemax.dailyspin.unlocker.model.QuizScoreManager;

public class Quiz_4_Activity extends BaseActivity {

    ActivityQuiz4Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityQuiz4Binding.inflate(getLayoutInflater());
        ...
        binding.btnNext.setOnClickListener(v -> {
            ...
            startActivity(new Intent(this, Quiz_5_Activity.class));
            finish();
        });
    }
